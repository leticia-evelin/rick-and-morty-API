...
import br.senai.sp.jandira.rickandmorty.model.Location
...
fun Greeting(name: String) {
    ...
    Column(modifier = Modifier.padding(32.dp)) {
        Button(onClick = {
            //chamada para API
            val call = RetrofitFactory().getCharacterService().getCharactersByPage(2)
        ...
        LazyColumn(){
            items(results){
               Card(
                   ...
                   //padding serve para o lado de fora
